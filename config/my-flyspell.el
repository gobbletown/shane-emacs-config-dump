...
(defun my-flyspell-next ()
  (interactive)
  (flyspell-mode t)
  (my-flyspell-buffer)
  (flyspell-goto-next-error))

(defun my-flyspell-prev ()
  (interactive)
  (flyspell-mode t)
  (my-flyspell-buffer)
...
;; (advice-add 'my-flyspell-add-word :around #'my-flyspell-add-word-around-advice)
;; (advice-remove 'my-flyspell-add-word  #'my-flyspell-add-word-around-advice)
