...
(define-key minibuffer-local-map (kbd "M-;") (lm (my/beep)))

;; This doesn't save and I don't need it because I'm using the evil-minibuffer for saving
;; (define-key minibuffer-local-map (kbd "M-;") '(lambda () (interactive) (ignore-errors (exit-minibuffer) (my-save-buffer))))


;; This changes the mode. I don't want this.
;; (add-hook 'miniedit-mode-hook (lm (emacs-lisp-mode)))

(add-hook 'miniedit-mode-hook (lm (my/lisp-mode 1)))
