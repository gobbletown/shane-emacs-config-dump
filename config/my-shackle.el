  ...
  (progn
    ...
    (setq shackle-rules
          '(
            ...
            ;; ("*Free keys*" :ignore nil :select nil :same nil :align my-shackle-sensible-alignment)
            ...
            ("*Help*" :select t :same t :align my-shackle-sensible-alignment)
            ;; ("*Help*" :other t :select nil :same nil :align my-shackle-sensible-alignment :size 0.5)
            ("\\*helpful .*" :regexp t :other t :select nil :same nil :align my-shackle-sensible-alignment :size 0.5)
