(define-key my-mode-map (kbd "M-l E .") (df edit-my-editing (find-file "/home/shane/var/smulliga/source/git/config/emacs/config/my-editing.el")))
(define-key my-mode-map (kbd "M-l E d") (df deselect-i (deselect)))
(define-key my-mode-map (kbd "M-l E r") (df reselect-i (reselect-last-region)))
