...
(if (not (cl-search "SPACEMACS" my-daemon-name))
    (load "/home/shane/var/smulliga/source/git/spacemacs/layers/+emacs/org/local/evil-org/evil-org.el"))
...
;;       (quote (("j" "Journal Entry" entry (file+olp+datetree "~/Documents/Journal/journal.org") "* %T %a\n%?" :tree-type week)
...
;; vim +/"(define-key org-mode-map \"\C-e\" 'org-end-of-line" "$MYGIT/config/emacs/packages-spacemacs/org-plus-contrib-20180312/org.el"
