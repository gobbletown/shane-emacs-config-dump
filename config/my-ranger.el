...
;; (define-key ranger-mode-map (kbd "v") 'eshell-sph)
...
;; (define-key ranger-mode-map (kbd "r") 'dired-here)
...
(define-key ranger-mode-map (kbd "r") 'my-ranger-to-dired)
