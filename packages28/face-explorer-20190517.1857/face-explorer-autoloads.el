;;; face-explorer-autoloads.el --- automatically extracted autoloads
;;
;;; Code:
...
If called interactively, enable Face-Explorer-Tooltip mode if ARG
...
With prefix ARG, enable Face-Explorer-Tooltip-Global mode if ARG is positive;
otherwise, disable it.  If called from Lisp, enable the mode if
ARG is omitted or nil.

Face-Explorer-Tooltip mode is enabled in all buffers where
`(lambda nil (face-explorer-tooltip-mode 1))' would do it.
See `face-explorer-tooltip-mode' for more information on Face-Explorer-Tooltip mode.
...
If called interactively, enable Face-Explorer-Simulate-Display
...
With prefix ARG, enable Face-Explorer-Simulate-Display-Global mode if ARG is positive;
otherwise, disable it.  If called from Lisp, enable the mode if
ARG is omitted or nil.

Face-Explorer-Simulate-Display mode is enabled in all buffers where
`(lambda nil (unless (derived-mode-p 'face-explorer-common-mode) (face-explorer-simulate-display-mode 1)))' would do it.
See `face-explorer-simulate-display-mode' for more information on Face-Explorer-Simulate-Display mode.
