...
Returns what we should use as `default-directory'." nil nil)
...
root of the current git or mercurial repository OR a project root
defined by the optional `project-root.el' package OR the default
directory if none of the above is found." t nil)
...
Run the `compile' function from the project root." t nil)

(autoload 'ftf-gdb "find-things-fast" "\
Run the `gdb' function from the project root." t nil)

(register-definition-prefixes "find-things-fast" '("ftf-"))
