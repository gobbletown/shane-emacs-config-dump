...
(autoload 'cssh-turn-on-ibuffer-binding "cssh" nil nil nil)

(autoload 'cssh-term-remote-open "cssh" "\
Prompt for a remote host to connect to, and open a term there." t nil)
...
In dired, have cssh connect to hosts in the `dsh' configuration file." t nil)
...
(register-definition-prefixes "cssh" '("cssh-" "split-horizontally-first"))
