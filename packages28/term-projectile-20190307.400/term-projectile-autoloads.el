...
Switch forward to the next term-projectile ansi-term buffer for `defualt-directory'." t nil)

(autoload 'term-projectile-default-directory-backward "term-projectile" "\
Switch backward to the next term-projectile ansi-term buffer for `defualt-directory'." t nil)
