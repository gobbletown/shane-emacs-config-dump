...

;;;### (autoloads nil "network-watch" "network-watch.el" (0 0 0 0))
...
If called interactively, enable Network-Watch mode if ARG is
...
(register-definition-prefixes "network-watch" '("network-watch-"))
