...
(register-definition-prefixes "butler" '("butler-" "draw-" "find-current-" "generate-progress-string" "hide-butler-job" "parse-jobs" "refresh-butler-status" "trigger-butler-job"))
...
(register-definition-prefixes "butler-servers" '("butler-" "generate-basic-auth" "get-" "parse-authinfo-file" "prepare-servers"))
...
(register-definition-prefixes "butler-util" '("colorize-dot"))
