...
(register-definition-prefixes "bazel-build" '("bazel-"))
...
(register-definition-prefixes "bazel-mode" '("bazel-mode"))
...
(register-definition-prefixes "bazel-util" '("bazel-util-"))
...
(register-definition-prefixes "bazelrc-mode" '("bazelrc-ffap"))
