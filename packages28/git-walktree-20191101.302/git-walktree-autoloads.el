...
(register-definition-prefixes "git-walktree" '("git-walktree-"))
...
(register-definition-prefixes "git-walktree-mode" '("git-walktree-"))
...
(register-definition-prefixes "git-walktree-read" '("git-walktree-read--"))
...
(register-definition-prefixes "git-walktree-utils" '("git-walktree-"))
