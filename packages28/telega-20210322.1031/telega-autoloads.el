...
(register-definition-prefixes "telega-ffplay" '("telega-ffplay-"))
...
(register-definition-prefixes "telega-filter" '("all" "any" "archive" "can-get-statistics" "chat-list" "contact" "custom" "default-disable-notification" "define-telega-filter" "fake-or-scam" "folder" "has-" "ids" "inactive-supergroups" "is-broadcast-group" "last-message-by-me" "main" "my-permission" "name" "nearby" "not" "online-status" "permission" "pin" "replies-messages" "restriction" "saved-messages" "search" "top" "tracking" "type" "unmuted" "unread" "verified"))
...
(register-definition-prefixes "telega-voip" '("telega-voip-"))
...
(register-definition-prefixes "telega-vvnote" '("telega-vvnote-"))
