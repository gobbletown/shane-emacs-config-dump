...
;;;***

;;;### (autoloads nil "ssh-deploy-test" "ssh-deploy-test.el" (0 0
;;;;;;  0 0))
;;; Generated autoloads from ssh-deploy-test.el

(register-definition-prefixes "ssh-deploy-test" '("ssh-deploy-test"))
