...
(register-definition-prefixes "hactypes" '("annot-bib" "completion" "display-" "eval-elisp" "exec-" "function-in-buffer" "hyp-" "link-to-" "man-show" "rfc-toc" "text-toc"))
...
(register-definition-prefixes "hbut" '("defib" "ebut:" "hattr:summarize" "hbut:" "ibtype:create" "ibut:" "map-"))
...
(register-definition-prefixes "hsmail" '("mail-" "smail:"))
...
(register-definition-prefixes "hsys-org" '("hsys-org-" "inhibit-hsys-org" "org-"))
