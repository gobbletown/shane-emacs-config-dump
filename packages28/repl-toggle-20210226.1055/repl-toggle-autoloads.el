...
If called interactively, enable Repl-Mode mode if ARG is
...
Activate the repl-toggle minor mode." nil nil)

(register-definition-prefixes "repl-toggle" '("repl-toggle-mode-map" "rtog/"))
