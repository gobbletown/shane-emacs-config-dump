...
Main function to snooze current line and pick time." t nil)

(autoload 'org-snooze-pop "org-snooze" "\
Main function to pop a snoozed item that Emacs agenda just send notification." t nil)

(register-definition-prefixes "org-snooze" '("org-snooze-"))
