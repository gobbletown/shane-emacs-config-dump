...
Show the list of existing tags in your Evernote." t nil)

(autoload 'geeknote-notebook-list "geeknote" "\
Show the list of existing notebooks in your Evernote." t nil)
...
Show information about active user." t nil)
...
(register-definition-prefixes "geeknote" '("geeknote-"))
