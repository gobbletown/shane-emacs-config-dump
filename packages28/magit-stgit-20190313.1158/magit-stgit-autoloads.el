...

;;;### (autoloads nil "magit-stgit" "magit-stgit.el" (0 0 0 0))
;;; Generated autoloads from magit-stgit.el

(autoload 'magit-stgit-init "magit-stgit" "\
Initialize StGit support for the current branch." t nil)
...
If called interactively, enable Magit-Stgit mode if ARG is
...
(register-definition-prefixes "magit-stgit" '("magit-"))
