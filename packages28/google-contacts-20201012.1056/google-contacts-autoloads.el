...
(register-definition-prefixes "google-contacts" '("google-contacts-" "xml-node-"))
...
(register-definition-prefixes "google-contacts-gnus" '("google-contacts-gnus-"))
...
(register-definition-prefixes "google-contacts-message" '("google-contacts-"))
...
(register-definition-prefixes "google-oauth" '("google-oauth-"))
...
(register-definition-prefixes "google-org-contacts" '("google-org-contacts--insert"))
